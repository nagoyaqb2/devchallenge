...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>Contact - UX Studio</title>
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta name="description" content="Developer challenge for UX Studio" />
        <link rel="icon" href="/favicon.ico" />
      </head>
      <body>
        <Providers>
          <main className="flex flex-row min-h-screen w-full bg-[#141414] text-white">
            <div className="flex-col flex-grow hidden w-auto md:flex">
              <div className="hidden md:flex h-[97px] border-b border-[#282828]"></div>
              <div className="flex h-[97px] border-b border-[#282828] px-6 py-[28px] justify-end">
                <div className="p-2">
                  <svg
                    width="24"
                    height="24"
              ...
              <div className="flex-grow h-auto"></div>
            </div>
            <div className="flex-col flex-grow max-w-[768px] w-fit">
              <div className="hidden md:flex h-[97px] border-b border-l border-r border-[#282828]"></div>
              <div className="w-full mx-auto">{children}</div>
            </div>
            <div className="flex-col flex-grow hidden w-auto md:flex">
              <div className="hidden md:flex h-[97px] border-b border-[#282828]"></div>
              <div className="h-[97px] border-b border-[#282828] px-6 py-[28px] justify-end">
                <div className="p-2">
                  <svg
                    width="24"
                    height="24"
